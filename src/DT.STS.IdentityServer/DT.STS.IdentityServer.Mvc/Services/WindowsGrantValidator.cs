...
namespace DT.STS.IdentityServer.Mvc.Services
{
    public class WindowsGrantValidator : ICustomGrantValidator
    {
        ...
        public async Task<CustomGrantValidationResult> ValidateAsync(ValidatedTokenRequest request)
        {
            ...
            var nameIdentifierClaim = principal.Claims.FirstOrDefault(x => x.Type == IdentityServer3.Core.Constants.ClaimTypes.Name);
        ...
        {
            var nameClaim = claimsFromExternalProvider.FirstOrDefault(x => x.Type == IdentityServer3.Core.Constants.ClaimTypes.Name);
