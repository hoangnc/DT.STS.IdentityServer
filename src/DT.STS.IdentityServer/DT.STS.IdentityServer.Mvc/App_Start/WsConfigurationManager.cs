...
namespace DT.STS.IdentityServer.Mvc.App_Start
{
    ...
    public class WsConfigurationManager : ConfigurationManager<OpenIdConnectConfiguration>
    {
        ...
        public WsConfigurationManager(string metadataAddress)
            : this(metadataAddress, new WsHttpDocumentRetriever())
        {
        }
